...
namespace Integrations.Implementations.Paystack
{
    public partial class PaystackApiService
    {
        ...
        public Task<PaymentBaseResponse<SettleTransactionResponse>> SettleBulkTransaction(BulkSettleTransactionRequest settleTransactionRequest, Func<object, string, string, string, Task> cleanUp = null)
            => throw new NotImplementedException("SettleBulkTransaction API is not available for Paystack");

        public Task<PaymentBaseResponse<SettleBulkTransactionStatusResponse>> SettleBulkTransactionEnquiry(string rrr, Func<object, string, string, string, Task> cleanUp = null)
